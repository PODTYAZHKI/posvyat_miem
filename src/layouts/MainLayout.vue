  ...
  <q-layout view="lHr lpR fFf">
    <q-header elevated>
      <q-toolbar style="padding-left: 10%; padding-right: 10%; height: 8.45vw;">
        ...
        <q-space />
        <q-btn color="secondary" icon="img:icons/vk.png" class="q-mr-md header-btn" v-if="$q.screen.gt.xs" @click="go('https://vk.com/miemposvyat')"/>
        <q-btn color="secondary" icon="img:icons/telegram.png" v-if="$q.screen.gt.xs" class="header-btn" @click="go('https://t.me/miemposvyat')"/>
    ...
    <q-drawer side="right" v-model="drawerRight" show-if-above bordered overlay :width="200" v-if="$q.screen.lt.sm">
      <q-scroll-area class="fit drawer">
        <div class="q-pa-md">
          <q-btn color="secondary" icon="img:~assets/images/vk.png" padding="10px 10px" class="q-mr-md"
            @click="go('https://vk.com/miemposvyat')" />
          <q-btn color="secondary" icon="img:~assets/images/telegram.png" padding="10px 10px" @click="go('https://t.me/miemposvyat')" />
